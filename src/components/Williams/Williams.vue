<template>
  <div class="grid grid-flow-row">
    <div id="1980">
      ...
      <div class="float-left pl-12 mr-4 pb-12">
        <img
          src="/Images/Williams/williams1980.png"
          class="Williams-img"
          alt="Alan Jones"
        />
      </div>
      <div class="pl-12 pr-8 pt-2 text-4xl text-justify">
        <p class="">
          ...
          in Argentina and then followed with four more wins at French GP,
          British GP, Canadian GP and the win at the last race in United States.
          Jones also won the driver's title 17 points ahead of Nelson Piquet. In
    ...
    <div id="1981">
      ...
      <div class="pl-12 pr-8 pt-2 text-4xl text-justify">
        <p class="">
          ...
          Brazilian GP and the Belgian GP. The team won the constructor's
          championship with 120 points, 29 points ahead of Ferrari. The title
          crown went to Nelson Piquet. Williams won back to back titles despite
          having this year more competition from Ferrari and Brabham.
        </p>
        <p class="pt-4">
          In 1981 championship season was the first to run under FIA Formula One
          World Championship name. The entry rules were changed and prize money
          was introduced. Formula one started to become more commercial.
        </p>
      </div>
    </div>
    <div id="1986">
      ...
      <div class="float-left pl-12 mr-4 pb-12">
        <img
          src="/Images/Williams/theGangFour.png"
          class="Williams-img"
      ...
      <div class="pl-12 pr-12 pt-2 text-4xl text-justify">
        <div class="pt-2">
          ...
          Senna – who won all but one of the 16 races that season. The season
          started in Brazil, where Piquet won and Senna finished second, while
          Prost and Mansell retired. Throughout the season, all four drivers
          exchanged podium places, with Prost finishing the season with 11
          podium finishes. The only race where none of the four drivers won the
        ...
        <div class="pt-4">
          ...
          that left him in a wheelchair. in 1989.
        </div>
      </div>
    </div>
    <div id="1987">
      ...
      <div class="pl-12 pr-8 pt-4 text-4xl text-justify">
        <p class="">
          ...
          races while his team mate Nigel won six but due his crash in Japanese
          GP he lost the title to the Piquet. Williams won the constructor's
          title with 137 points, 61 points ahead of McLaren.
        </p>
        <p class="pt-4">
          At the end of the year Honda ended their partnership with Williams and
          moved to McLaren. Pirelli left the sport and Goodyear was the sole
          tyre supplier.
        </p>
      </div>
    </div>
    <div id="1992">
      ...
      <div class="float-left pl-12 mr-4 pb-12">
        <img
          src="/Images/Williams/mansell.png"
          class="Williams-img"
      ...
      <div class="pl-12 pr-8 pt-2 text-4xl text-justify">
        <div class="pt-2">
          ...
          the next four races. Mansell winning five opening races set the new
          record in Formula One. Mansell went on to record for more wins, ending
          the season with record high nine season wins which was the new record
          in Formula One. Mansell won the driver's title with 108 points, 52
          points ahead of his team mate Patrese. Williams won the constructor's
          title with 164 points, 65 points ahead of McLaren.
        </div>
        <div class="pt-4">
          Williams signed Prost for the 1993 season and promoted their test
          driver Damon Hill.
        </div>
      </div>
    </div>
    <div id="1993">
      ...
      <div class="pl-12 pr-8 pt-2 text-4xl text-justify">
        <p class="">
          ...
          the other teams. Prost won the opening race in South Africa dominating
          the whole weekend and winning with over a minute ahead of Senna. After
          the collision in Brazil. Prost won the next three of the four GP. In
          France Prost and Hill finished 1-2 that was the only 1-2 for the
          Williams that season. Prost won in Silverstone and Hockenheim. Hill
          won his first race in Hungary, continued his winning streak in Belgium
          and Italy. After Italy Williams failed to win any races. Williams
          retained their Constructors' title, 84 points ahead of second-placed
          McLaren. Prost clinched the Drivers' Championship in Portugal and
          finished the season 26 points ahead of second-placed Senna.
        </p>
        <p class="pt-4">
          1993 marked the final season that Williams ran with Canon as its
          primary backer.
        </p>
      </div>
    </div>
    <div id="1994">
      ...
      <div class="pl-12 pr-8 pt-2 text-4xl text-justify">
        <div class="pt-2">
          ...
          sport. The FIA banned the active suspension and traction control
          systems. The Williams FW16 was a difficult car to drive and Senna
          struggled with it. Schumacher won the first two rounds. At the San
          Marino the whole weekend started badly first Rubens Barrichello had a
          big crash on Friday. On Saturday Roland Ratzenberger died in the
          crash. On Sunday on the lap 6 Senna lost the control of the car and
          crashed into the wall. Senna died from the injuries. As a mark of
          respect all Williams cars up until 2022 were marked with Senna 's'.
        </div>
        <div class="pt-4">
          Hill won in Spain taking team's first win in the season. Hill won in
          Germany and then followed with three wins in Belgium, Italy and
          Portugal and the final win in Japan. Despite having tragic year
          Williams won the constructor's title with 118 points, 15 points ahead
          of Benetton.
        </div>
      </div>
    </div>
    ...
    <div id="1997" class="pb-12">
      ...
      <div class="float-left pl-12 mr-4 pb-12">
        <img
          src="/Images/Williams/williams1997.png"
          class="Williams-img"
