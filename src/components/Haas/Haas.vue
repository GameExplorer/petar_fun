<template>
  ...
  <div class="timeline text-xl text-justify">
    <p id="2016" class="road font-semibold">
      ...
      its debut. Grosjean success continued in the Bahrain finishing P5 after
      that they fell off and only scored points on three more occassions socring
      enough points to secure P8 in the constructor's standings.
      <br />
    </p>
    <p id="2018" class="road font-semibold">
      ...
      similar to previous' year Ferrari SF70H. Guiterez was replaced by
      Magnussen. Again Haas scored points in Australia finishing P5 and P6. In
      Austria both went one better and finished P4 and P5 surpassing 2017 points
      tally after only nine races. At the Singapore GP, Magnussen scored Haas'
      first ever fastest lap. They ended season in fifth position. This was
    ...
    <p id="2021" class="road font-semibold">
      ...
      first race Nikita spun on the lap 1 and Mick finished P16 last of all
      running cars. The season was a disaster for Haas, they failed to score a
      single point and finished last in the constructor's standings. Nikita was
    ...
    <p id="2022" class="road font-semibold">
      ...
      both drivers score points, Mick scored his best position P8 and Magnussen
      finished P10. The momentum continued in the following race where Mick
      finished P6 his best race result so far. In Brazil team took maiden pole
      with Magnussen out-qualifying the field in changing conditions. Haas
      finished P7 in the constructor's standings. Mick departed Haas after the
      season.
    </p>
    <p id="2024" class="road font-semibold">
      ...
      usually finished outside the points. Haas finished the season in P10 with
      12 points. Hulkenberg P7 in the American GP was their best result. Few
      days after the new year Haas announced that Gunther Steiner contract will
      not be renewed. He was replaced by engineer Ayao Komatsu.
    </p>
  </div>
</template>
