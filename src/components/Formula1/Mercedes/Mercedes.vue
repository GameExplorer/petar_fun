<template>
  <div class="timelineMercedes">
    <ol class="years">
      <li v-for="year in years" :key="year.id" :id="year.id" class="year">
        <h1 class="text-6xl pt-2 uppercase header">
          <span class="border-b-4 border-white pr-8">{{ year.title }}</span>
        </h1>
        <div class="content timeline-date text-3xl pt-2 text-justify">
          <p class="context">{{ year.description }}</p>
          <img
            :src="year.imageSrc"
            :alt="year.imageAlt"
            class="pt-2 rounded-xl shadow-lg shadow-gray-500"
          />
        </div>
      </li>
    </ol>
      ...
      years: [
        {
          ...
          imageSrc: "/Images/Mercedes/mercedes2014.png",
        ...
        },
        {
          ...
          imageSrc: "/Images/Mercedes/mercedes2015.png",
        ...
        },
        {
          ...
          imageSrc: "/Images/Mercedes/mercedes2016.avif",
        ...
        },
        {
          ...
          imageSrc: "/Images/Mercedes/mercedes2017.png",
        ...
        },
        {
          ...
          imageSrc: "/Images/Mercedes/hamiltonVettel2018.png",
          imageAlt: "Mercedes v Ferrari",
        },
        {
          id: "2019",
          ...
          imageSrc: "/Images/Mercedes/mercedes2019.avif",
        ...
        },
        {
          ...
          imageSrc: "/Images/Mercedes/mercedes2020.png",
        ...
        },
        {
          ...
          imageSrc: "/Images/Mercedes/mercedes2021.png",
...
.year:hover::before {
  ...
  box-shadow: 0px 0px 15px 12px #c8ccce;
}
</style>
